...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::create('intro_bds', function (Blueprint $table) {
            ...
            $table->integer('sort_order')->default(0)->comment('For manual ordering');
            $table->integer('featured_order')->default(0)->comment('Order in featured section');
            $table->integer('category_order')->default(0)->comment('Order within category');
