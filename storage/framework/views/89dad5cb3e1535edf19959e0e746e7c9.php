...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['paginate' => null]));
...
foreach (array_filter((['paginate' => null]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<div class="w-full">
    ...
    <div <?php echo e($attributes->except('paginate')->class(['overflow-auto border ...'])); ?>>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($paginate): ?>
        <div class="mt-4">
...
<?php /**PATH /var/www/html/totthobox/resources/views/flux/table/index.blade.php ENDPATH**/ ?>