...
>
    ...
    >
        <div class="flex items-center gap-2 overflow-hidden">
            ...
            <span x-text="value ? value : '<?php echo e($placeholder); ?>'" :class="value ? 'text-zinc-900 dark:text-zinc-100' : 'text-zinc-400'" class="font-medium"></span>
        </div>
...
</div><?php /**PATH /var/www/html/totthobox/resources/views/flux/date-picker.blade.php ENDPATH**/ ?>