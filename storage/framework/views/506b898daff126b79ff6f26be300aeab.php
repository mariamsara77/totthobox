           ...
           leading-none select-none text-[clamp(3.5rem,8vw,7rem)]">
            ...
            <div class="max-w-prose">
                ...
                <p class="mt-3 text-base md:text-lg text-zinc-600 dark:text-zinc-300 leading-relaxed">
                    এই পৃষ্ঠায় প্রবেশ করতে লগইন বা অনুমতি প্রয়োজন। অনুগ্রহ করে লগইন করুন বা হোমপেজে ফিরে যান।
                </p>
            </div>
...
<?php endif; ?>
<?php /**PATH /var/www/html/totthobox/resources/views/errors/401.blade.php ENDPATH**/ ?>