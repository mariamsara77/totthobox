           ...
           leading-none select-none text-[clamp(3.5rem,8vw,7rem)]">
            ...
            <div class="max-w-prose">
                ...
                <p class="mt-3 text-base md:text-lg text-zinc-600 dark:text-zinc-300 leading-relaxed">
                    কিছু ভুল হয়েছে। আমাদের টিম এটি সমাধান করছে। অনুগ্রহ করে পরে আবার চেষ্টা করুন বা হোমপেজে ফিরে যান।
                </p>
            </div>
...
<?php endif; ?>
<?php /**PATH /var/www/html/totthobox/resources/views/errors/500.blade.php ENDPATH**/ ?>