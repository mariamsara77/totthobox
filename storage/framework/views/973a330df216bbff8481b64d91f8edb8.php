...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::input.index','data' => ['xModel' => 'search','xRef' => 'searchInput','@click.stop' => true,'size' => 'sm','icon' => 'magnifying-glass','placeholder' => 'Filter...']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['x-model' => 'search','x-ref' => 'searchInput','@click.stop' => true,'size' => 'sm','icon' => 'magnifying-glass','placeholder' => 'Filter...']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
