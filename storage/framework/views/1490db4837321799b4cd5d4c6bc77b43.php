...
<?php
    ...
    // ->add($invalid ? 'border border-red-500' : '');
?>

<select <?php echo e($attributes->class($classes)); ?> <?php if($invalid): ?> aria-invalid="true" data-invalid <?php endif; ?>
    <?php if(isset($name)): ?> name="<?php echo e($name); ?>" <?php endif; ?>
    <?php if(is_numeric($size)): ?> size="<?php echo e($size); ?>" <?php endif; ?> data-flux-control data-flux-select-native
...
<?php /**PATH /var/www/html/totthobox/resources/views/flux/select/variants/default.blade.php ENDPATH**/ ?>