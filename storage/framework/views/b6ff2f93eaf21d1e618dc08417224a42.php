...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::input.index','data' => ['wire:model.live.debounce.300ms' => 'search','placeholder' => 'খাবারের নাম দিয়ে খুঁজুন...','size' => 'sm','icon' => 'magnifying-glass']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['wire:model.live.debounce.300ms' => 'search','placeholder' => 'খাবারের নাম দিয়ে খুঁজুন...','size' => 'sm','icon' => 'magnifying-glass']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::button.index','data' => ['wire:click' => 'filterByCategory(null)','size' => 'sm','variant' => ''.e($selectedCategory === null ? 'filled' : 'subtle').'','class' => 'px-4 py-2 rounded-full text-sm font-medium transition-all']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'filterByCategory(null)','size' => 'sm','variant' => ''.e($selectedCategory === null ? 'filled' : 'subtle').'','class' => 'px-4 py-2 rounded-full text-sm font-medium transition-all']); ?>সব <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if (isset($component)) { $__componentOriginalc04b147acd0e65cc1a77f86fb0e81580 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc04b147acd0e65cc1a77f86fb0e81580 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::button.index','data' => ['wire:click' => 'filterByCategory('.e($cat->id).')','size' => 'sm','variant' => ''.e($selectedCategory === $cat->id ? 'filled' : 'subtle').'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('flux::button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'filterByCategory('.e($cat->id).')','size' => 'sm','variant' => ''.e($selectedCategory === $cat->id ? 'filled' : 'subtle').'']); ?>
...
<?php endif; ?>
                    ...
                    <div x-show="!open" class="mt-2 flex justify-between items-center text-sm text-zinc-500">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($food->view_count > 0): ?>
                            <span class="text-[10px] opacity-70">দেখা হয়েছে: <?php echo e($food->view_count); ?> বার</span>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                </div>
                    ...
                    <div class="px-4 pb-5 pt-2 border-t border-zinc-100 dark:border-zinc-800">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($food->serving_size): ?>
                            <div class="text-xs mb-3 text-primary font-medium italic">
                                * প্রতি <?php echo e($food->serving_size); ?> পরিবেশন অনুযায়ী
                            </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                        <div class="flex justify-between text-lg font-bold mb-4">
                            <div>মোট শক্তিঃ</div>
                            <div class="text-primary"><?php echo e($food->calorie ?? '-'); ?> ক্যালোরী</div>
                        </div>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($food->description): ?>
                            <div class="pt-3 border-t border-zinc-100 dark:border-zinc-800">
                                <p class="text-sm text-zinc-500 leading-relaxed">
                                    <strong>বর্ণনা:</strong> <?php echo e($food->description); ?>
...
[$__name, $__params] = $__split('global.nodata-message', ['title' => 'ক্যালরী চার্ট','search' => $search]);

$key = null;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-307044628-1', null);
