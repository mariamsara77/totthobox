...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.settings.layout','data' => ['heading' => __('পছন্দসমূহ (Appearance)'),'subheading' => __('আপনার অ্যাকাউন্টের প্রদর্শন সেটিংস আপডেট করুন')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
</section><?php /**PATH /var/www/html/totthobox/resources/views/livewire/settings/appearance.blade.php ENDPATH**/ ?>