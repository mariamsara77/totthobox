...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::textarea','data' => ['wire:model' => 'description','label' => 'Description (Optional)']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'description','label' => 'Description (Optional)']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
        ...
        <table class="min-w-full text-center">
            ...
            <tbody>
                ...
                <tr class="hover:bg-zinc-400/10 border-b border-zinc-400/10">
                    <td class="py-3 px-2"><?php echo e($cat->icon ?? '-'); ?></td>
                    <td class="py-3 px-2"><?php echo e($cat->name); ?></td>
                    <td class="py-3 px-2"><?php echo e($cat->slug); ?></td>
                    <td class="py-3 px-2"><?php echo e($cat->is_featured ? 'Yes' : 'No'); ?></td>
                    <td class="py-3 px-2"><?php echo e($cat->is_active ? 'Yes' : 'No'); ?></td>
                    <td class="py-3 px-2"><?php echo e($cat->status); ?></td>
                    <td class="py-3 px-2 space-x-2">
                        <button wire:click="edit(<?php echo e($cat->id); ?>)" class="text-blue-600">Edit</button>
                        <button wire:click="delete(<?php echo e($cat->id); ?>)" class="text-red-600">Delete</button>
                    </td>
                </tr>
...
</div><?php /**PATH /var/www/html/totthobox/resources/views/livewire/admin/contact/contact-category-manage.blade.php ENDPATH**/ ?>