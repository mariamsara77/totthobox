           ...
           leading-none select-none text-[clamp(3.5rem,8vw,7rem)]">
            ...
            <div class="max-w-prose">
                ...
                <p class="mt-3 text-base md:text-lg text-zinc-600 dark:text-zinc-300 leading-relaxed">
                    আপনার অনুরোধটি সার্ভার বুঝতে পারছে না। অনুগ্রহ করে ঠিকভাবে চেষ্টা করুন অথবা হোমপেজে ফিরে যান।
                </p>
            </div>
...
<?php endif; ?>
<?php /**PATH /var/www/html/totthobox/resources/views/errors/400.blade.php ENDPATH**/ ?>