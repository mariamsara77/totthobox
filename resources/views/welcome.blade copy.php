...
<x-seo title="মূল সেবা"
    description="Totthobox-এ পাবেন বাংলাদেশ জেলা তথ্য, ইসলামিক শিক্ষা, স্বাস্থ্য জ্ঞান, জরুরী নম্বর, ছুটির তালিকা এবং এক্সেল এক্সপার্ট টিপসসহ প্রয়োজনীয় সকল ডিজিটাল সেবা।"
    keywords="তথ্যবক্স হোমপেজ, বাংলাদেশ সার্ভিস পোর্টাল, অনলাইন এমসিকিউ, শিশুশিক্ষা, কারেন্সি কনভার্টার, এক্সেল টিপস" />
    <div class="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-wrap justify-center text-center">
            ...
            @php
$firstContact = cache()->remember('home_first_contact', 3600, function () {
    return App\Models\ContactCategory::query()->active()->first();
});

$firstSign = cache()->remember('home_first_sign', 3600, function () {
    return App\Models\SignCategory::query()->active()->first();
});

$firstExcel = cache()->remember('home_first_excel', 3600, function () {
    return App\Models\ExcelTutorial::query()->first();
});
...
<div class="flex items-center justify-center gap-6 mt-12 mb-6">
    <flux:link href="/privacy-policy">গোপনীয়তা নীতি</flux:link>
    <flux:link href="/terms-of-service">ব্যবহারের শর্তাবলী</flux:link>
    <flux:link href="/contact-us">যোগাযোগ</flux:link>
</div>
