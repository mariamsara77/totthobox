...
<div class="max-w-7xl mx-auto" x-data="modernDrawingApp()" x-init="init()">
            ...
            <div class="flex items-center justify-between mb-2">
                ...
                <div class="flex items-center space-x-2">
                    <flux:modal.trigger name="help">
                        <flux:button variant="ghost" class="!text-gray-600" size="sm" icon="question-mark-circle"
                            title="Help">
                        </flux:button>
                    </flux:modal.trigger>

                    <flux:button variant="ghost" size="sm" @click="toggleFullscreen()">
                        ...
                        <div class="flex items-center justify-center space-x-1 sm:space-x-2">
                            ...
                            <div class="flex items-center space-x-1">
                                ...
                                <flux:modal.trigger name="canvas-save-confirm">
                                    <flux:button variant="ghost" class="!text-green-600" size="sm"
                                        icon="arrow-down-tray" title="Save">
                                    </flux:button>
                                </flux:modal.trigger>

                                <flux:modal.trigger name="canvas-clear-confirm">
                                    <flux:button variant="ghost" class="!text-red-500" size="sm" icon="trash"
                                        title="Clear">
                                    </flux:button>
                                </flux:modal.trigger>

                                <flux:modal.trigger name="settings-writing-pad">
                                    <flux:button variant="ghost" class="!text-purple-500" size="sm" icon="cog-6-tooth"
                                        title="Settings">
                                    </flux:button>
                                </flux:modal.trigger>
    ...
    <flux:modal name="canvas-clear-confirm" class="min-w-[22rem]">
        ...
        <div class="space-y-6">
            ...
            <div class="flex gap-2 justify-end">
                <flux:button variant="ghost" size="sm" x-on:click="$flux.modal('canvas-clear-confirm').close()">
                    Cancel</flux:button>

                <flux:button type="submit" size="sm" @click="clearCanvas()" variant="danger"
                    x-on:click="$flux.modal('canvas-clear-confirm').close()">Clear</flux:button>
            </div>
        </div>
    </flux:modal>
    <flux:modal name="canvas-save-confirm" class="min-w-[22rem]">
        ...
        <div class="">
            ...
            <div class="space-y-6">
                <!-- File Name -->
                <flux:input type="text" x-model="fileName" label="File Name" />

                <!-- Format -->
                <flux:select x-model="saveFormat" label="Format">
                ...
                <div x-show="saveFormat === 'png'">
                    <flux:checkbox x-model="transparentBackground" label="Transparent background" />
                </div>
            </div>
        </div>

        <div class="mt-3 flex gap-2 justify-end">
            <flux:button size="sm" x-on:click="$flux.modal('canvas-save-confirm').close()">
                Cancel
            </flux:button>
            <flux:button variant="primary" size="sm" color="blue" @click="saveWithOptions()">
                Save Drawing
            </flux:button>
        </div>
