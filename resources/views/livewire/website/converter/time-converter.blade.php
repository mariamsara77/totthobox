...
new class extends Component
{
    ...
    // A protected property for conversion rates to a base unit (seconds)
    ...
    public function convertTime()
    {
        ...
        $this->outputValue = round($valueInSeconds / $outputRate, 6);
    }

    /**
     * This method swaps the units and triggers a new conversion.
     */
    public function swapTimeUnits()
    {
    ...
    <div class="w-full max-w-xl rounded-2xl space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-5 gap-4 items-center">
            <div class="md:col-span-2">
                ...
                <flux:input id="timeInputValue" type="number" wire:model.live.debounce.500ms="inputValue" placeholder="Enter value" />
            </div>

            <div class="flex justify-center md:col-span-1">
                <flux:button wire:click="swapTimeUnits" class="p-3 rounded-full">
            ...
            <div class="md:col-span-2">
                ...
                <flux:input id="timeOutputValue" type="number" wire:model="outputValue" disabled placeholder="Converted value" />
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
            <div>
                ...
                <flux:select id="timeInputUnit" wire:model.live="inputUnit">
            ...
            <div>
                ...
                <flux:select id="timeOutputUnit" wire:model.live="outputUnit">
                    <option value="millisecond">Millisecond (ms)</option>
                    <option value="second">Second ($s$)</option>
                    <option value="minute">Minute (min)</option>
                    <option value="hour">Hour (h)</option>
